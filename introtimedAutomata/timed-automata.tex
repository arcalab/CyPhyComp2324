...
We will explore an \alert{automaton-based formalism} with an explicit notion of 
\alert{clock} 
\begin{center}
\fbox{Timed Automata [Alur \& Dill, 90]}
\end{center}

Emphasis on the \alert{reachability} problem for showing (in)correctness 
...
\begin{itemize}
\item A toolbox for modelling and analysis of timed systems
\item Systems modelled as \alert{networks} of timed automata enriched
  with \alert{integer variables} and \alert{channel synchronisations}
\item Properties specified in a subset of \tikzmark{a1} CTL \tikzmark{a2}
\end{itemize}

\vfill
\begin{textblock*}{5cm}(8.5cm,8cm)
  \small{\url{https://uppaal.org/}}
\end{textblock*}
...
\begin{tikzpicture}[overlay,remember picture,
     ...
     \node[semitransparent, 
           fit=(a1) (a2),
           pin=below:\tiny{Computation Tree Logic}]  {};
\end{tikzpicture}
\end{slide}
